    ...
    art_humeri: new Joint(
        {
            id: "art_humeri", 
            label: "art. humeri", 
            types: [jointTypes.art_simplex, jointTypes.art_sphaeroidea],
        }
    ),
    art_cubiti: new Joint(
        {
            id: "art_cubiti", 
            label: "art. cubiti", 
            types: [jointTypes.art_composita, jointTypes.art_trochoidea, jointTypes.art_ginglymus], 
            description: `
    ...
    art_humeroulnaris: new Joint(
        {
            ...
            types: [jointTypes.art_simplex, jointTypes.art_ginglymus],
        }
    ),
    art_radioulnaris: new Joint(
        {
            ...
            types: [jointTypes.art_duplex, jointTypes.art_complexa, jointTypes.art_trochoidea],
        }
    ),
    art_radiocarpalis: new Joint(
        {
            ...
            types: [jointTypes.art_simplex, jointTypes.art_ellipsoidea],
        }
    ),
    ...
    art_genus: new Joint(
        {
            id: "art_genus", 
            label: "art. genus", 
            types: [jointTypes.art_complexa, jointTypes.art_ginglymus, jointTypes.art_trochoidea],
        }
    ),
    art_talocruralis: new Joint(
        {
            ...
            types: [jointTypes.art_composita, jointTypes.art_ginglymus],
        }
    ),
    art_talotarsalis: new Joint(
        {
            ...
            types: [jointTypes.art_composita], 
            description: `
